...
public class Coupon implements Delayed {
    ...
    public Coupon(String code, String expirationDate, TimeUnit unit) throws ParseException {
        this.code = code;
    ...
    public int compareTo(Delayed other) {
        return Long.compare(this.expirationTime, ((Coupon) other).expirationTime);
    }
